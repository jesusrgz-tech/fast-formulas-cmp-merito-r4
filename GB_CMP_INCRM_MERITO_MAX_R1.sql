...
============================================================================*/
L_PROM      = TO_NUMBER(GET_TABLE_VALUE('GB_CMP_LAC_LAS_INCREMENTO_MERITO', 'Incremento_Promedio', L_KEY_PAIS))
L_INFLACION = TO_NUMBER(GET_TABLE_VALUE('GB_CMP_LAC_LAS_INCREMENTO_MERITO', 'Inflacion_Minima', L_KEY_PAIS))
...
============================================================================*/
IF L_KEY_PAIS = 'COL' THEN
(
    L_RANGO_MAX  = GET_TABLE_VALUE('GB_CMP_CO_RANGOS_MERITO', 'Rango_Maximo', L_CLAVE)
    L_APLICA_INF = GET_TABLE_VALUE('GB_CMP_CO_RANGOS_MERITO', 'Aplica_Inflacion', L_CLAVE)
)
ELSE
(
    L_RANGO_MAX  = GET_TABLE_VALUE('GB_CMP_LAS_LAC_RANGOS_MERITO', 'Rango_Maximo', L_CLAVE)
