...
DESCRIPTION       : Obtiene el valor minimo del grado. Fecha de contexto
                    ...
                    Se agrega diagnostico via GET_CONTEXT para confirmar
                    si el Assignment ID interno del motor de Compensation
                    coincide con el Assignment ID recibido como input.
**********************************************************************/
